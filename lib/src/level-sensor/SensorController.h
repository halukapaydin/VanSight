...
public:
     ...
     */
    bool addSensor(int index, int pin, float minResistance, float maxResistance, float referenceResistor, float adcResolution, float supplyVoltage);
     ...
     * 
     * @param sensorNum Sensor number (1-based index)
     * @return int ADC value (0-1023), -1 if invalid sensor
     */
